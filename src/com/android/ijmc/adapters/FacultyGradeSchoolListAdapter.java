...
import com.android.ijmc.adapters.FacultyCollegeListAdapter.ViewHolder;
...
public class FacultyGradeSchoolListAdapter extends BaseAdapter{
	
	Context context;
	LayoutInflater inflater;
	ArrayList<FacultyModel> faculties;

	public FacultyGradeSchoolListAdapter(Context context, ArrayList<FacultyModel> faculties) {
